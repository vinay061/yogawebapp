...
export default function Booking() {
    ...
    const formateDayTwo = format(zonedDayTwo, 'yyyy-MM-dd HH:mm:ss zzz', {timeZone: 'Europe/Luxembourg'})
    ...
    console.log(`Format F1: ${formatDayOne};; F2: ${formateDayTwo};; F3: ${formatDayThree}`)
