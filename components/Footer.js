                    ...
                    <div className="sm:flex sm:mt-8">
                        <div className="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
                            ...
                            <div className="flex flex-col">
                                ...
                                <button className="bg-red-200 px-4 py-2 mt-2 font-semibold text-white inline-flex items-center space-x-2 rounded transform hover:scale-110 transition duration-500">
                                ...
                                <button className="bg-blue-600 px-4 py-2 mt-2 font-semibold text-white inline-flex items-center space-x-2 rounded rounded transform hover:scale-110 transition duration-500">
