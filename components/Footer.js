                        ...
                        <div className="mt-8 sm:mt-0 sm:w-full sm:px-8 flex flex-col md:flex-row justify-between">
                            ...
                            <div className="flex flex-col">
                                <span className="font-bold text-white uppercase mt-4 md:mt-0 mb-2">Follow us on</span>
                                    ...
                                    <button className="bg-blue-500 px-4 py-2 font-semibold text-white inline-flex 
                                            items-center space-x-2 rounded transform hover:scale-110 
                                            transition duration-500">
                                        <svg className="w-5 h-5 fill-current" role="img" xmlns="http://www.w3.org/2000/svg" 
                                             viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 
                                        ...
                                        <Link href="https://www.facebook.com/Breath-Of-Yoga-104561578652685">
                                            <a target="_blank">facebook</a>
                                        </Link>
                                    </button>
                               
                                <button className="bg-red-200 px-4 py-2 mt-2 font-semibold text-black inline-flex 
                                        items-center space-x-2 rounded transform hover:scale-110 
                                        transition duration-500">
                                    <svg className="w-5 h-5 fill-current" role="img" xmlns="http://www.w3.org/2000/svg" 
                                        ...
                                        <defs>
                                            ...
                                            <radialGradient id="c" cx="158.429" cy="578.088" r="65" xlinkHref="#a" 
                                                            gradientUnits="userSpaceOnUse" gradientTransform="matrix(0 -1.98198 
                                                            1.8439 0 -1031.402 454.004)" fx="158.429" fy="578.088"/>
                                            <radialGradient id="d" cx="147.694" cy="473.455" r="65" xlinkHref="#b" 
                                                            gradientUnits="userSpaceOnUse" gradientTransform="matrix(.17394 .86872 
                                                            -3.5818 .71718 1648.348 -458.493)" fx="147.694" fy="473.455"/>
                                        </defs>
                                        ...
                                        <Link href="https://www.instagram.com/breathofyoga.lu/">
